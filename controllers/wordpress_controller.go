...
import (
	...
	examplecomv1 "github.com/daviddesroches/dwd-wordpress-1/api/v1"
)
...
// +kubebuilder:rbac:groups=example.com.example.com,resources=wordpresses,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=example.com.example.com,resources=wordpresses/status,verbs=get;update;patch
